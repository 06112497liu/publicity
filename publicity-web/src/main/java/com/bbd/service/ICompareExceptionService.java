...
public interface ICompareExceptionService {
     ...
     * @return
     */
    List<String> searchAnnualByExCount(int count, String sort, int sortType, PageBounds pb);
     ...
     * @return
     */
    List<String> searchAnnualByCompanyName(String companyName, String sort, int sortType, PageBounds pb);
     ...
     * @return
     */
    List<String> searchInstantlyByExCount(int count, String sort, int sortType, PageBounds pb);
     ...
     * @return
     */
    List<String> searchInstantlyByCompanyName(String companyName, String sort, int sortType, PageBounds pb);
     ...
     * @return
     */
    List<String> searchAllByExCount(int count, String sort, int sortType, PageBounds pb);
     ...
     * @return
     */
    List<String> searchAllByCompanyName(String companyName, String sort, int sortType, PageBounds pb);
