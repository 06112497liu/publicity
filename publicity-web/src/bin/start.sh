...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS -jar ./lib/reddata-publicity-web-1.0-SNAPSHOT.jar > $STDOUT_FILE 2>&1 &
